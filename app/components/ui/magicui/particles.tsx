  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particlesRef.current.forEach((particle) => {
        ...
        particle.x += particle.speedX * (1 - staticFactor) + force * (mousePositionRef.current.x - particle.x) * (ease / 100) * 0.01;
        particle.y += particle.speedY * (1 - staticFactor) + force * (mousePositionRef.current.y - particle.y) * (ease / 100) * 0.01;
